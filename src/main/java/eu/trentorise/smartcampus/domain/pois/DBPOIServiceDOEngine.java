...
public class DBPOIServiceDOEngine extends AbstractDOEngineImpl {

    public DBPOIServiceDOEngine() {
        super();
    }
...
Tuple body = new Tuple();
 body.put("serviceId","eu.trentorise.smartcampus.services.pois.ServicesPois");
getDomainObjectHandler().invokeOperation(obj, "subscribePois", body, ops, bundleId);}
}
return null;
}
    ...
    private Object _serviceNotification_update(Tuple tuple, DomainObjectWrapper obj, Set<DomainEvent> evts, Set<EvaluableDomainOperation> ops, String securityToken, String bundleId) throws DomainDataHandlerException {
        	 try {
		Tuple body = new Tuple();
		body.putAll((Map)new eu.trentorise.smartcampus.domain.pois.converter.PoiDataConverter().fromMessage((java.io.Serializable)tuple.get("data")));
...
return null;
    ...
    public String getType() {
        return "eu.trentorise.smartcampus.domain.pois.DBPOIService";
    }
    ...
    public Collection<DomainSubscriptionRule> getSubscriptions(DomainObjectWrapper obj, String bundleId) throws DomainDataHandlerException {
        ...
        
        {
            ...
            rule.setSourceType("eu.trentorise.smartcampus.services.pois.ServicesPois.GetPois");
    ...
    public it.sayservice.platform.domain.model.interfaces.DomainTypeInterface getInterface() throws it.sayservice.platform.core.domain.common.exception.DomainDataHandlerException {
        return eu.trentorise.smartcampus.domain.pois .DBPOIServiceInterface .getInstance();
    }
